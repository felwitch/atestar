<div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <img alt="image" src="imgs/atestar100x50.png">
          </div>
          <div class="sidebar-user">
            <div class="sidebar-user-picture">
              <img alt="image" src="imgs/avatar/avatar-6.jpg">
            </div>
          ...
          <div class="p-3 mt-4 mb-4">
            <a href="login.html" class="btn btn-danger btn-shadow btn-round btn-block">
              <div>Sair</div>
            </a>
          </div>
        </aside>
